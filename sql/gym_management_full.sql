-- ===================================
-- GYM MANAGEMENT DATABASE FULL SCHEMA
-- ===================================
...
-- Test data: admin/123, staff/123 (mật khẩu đã hash trước)
-- Password hash của "123": 202cb962ac59075b964b07152d234b70
...
-- Test data (hôm nay là 2026-05-13)
INSERT INTO subscriptions (member_id, package_id, start_date, end_date, price_at_purchase, status, payment_status) VALUES
(1, 1, '2026-05-01', '2026-05-31', 350000, 1, 1),  -- Member A, 1 tháng, đã thanh toán
(1, 2, '2026-06-01', '2026-08-29', 900000, 1, 0),  -- Member A, 3 tháng (sau), chưa thanh toán
(2, 3, '2026-01-01', '2026-12-31', 3000000, 1, 1), -- Member B, 1 năm, đã thanh toán
(3, 1, '2026-04-01', '2026-04-30', 350000, 2, 1);  -- Member C, hết hạn
